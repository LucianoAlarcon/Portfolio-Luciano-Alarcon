...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative min-h-screen px-8 md:px-16 py-32 bg-surface overflow-hidden"
    >
      {/* Background glow */}
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 100%, rgba(0,229,195,0.05) 0%, transparent 70%)",
        }}
      />
